...
if fits:
    ...
    sys.exit(
        "a box of this L/W doesnt fit into the domain at this angle, try a different config"
    )
...
OS += (
    np.array((-target_length, target_width)) * 0.5
)  # shifting origin to upper corner of target
